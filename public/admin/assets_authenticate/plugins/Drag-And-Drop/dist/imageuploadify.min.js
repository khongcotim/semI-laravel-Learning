	...
	$.fn.imageuploadify = function (opts) {
		...
		this.each(function () {
			...
			if (!$(self).attr("multiple")) {
				...
				let totalFiles = [];
				let counter = 0;
				let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="bx bxs-cloud-upload"></i><span class='imageuploadify-message'>Drag&Drop your file here to upload</span><button type="button"class="btn btn-default">or select file to upload</button></div></div>`);
				...
				const readingFile = (id, file) => {
					...
					if (file.type && file.type.search(/image/) != -1) {
						fReader.onloadend = function (e) {
							...
							if (totalFiles.length >1) {
								$('#warning_choose_img').removeClass('d-none');
							}
					...
					deleteBtn.on("click", function () {
						...
						if (totalFiles.length <=1) {
							$('#warning_choose_img').addClass('d-none');
						}
					});
