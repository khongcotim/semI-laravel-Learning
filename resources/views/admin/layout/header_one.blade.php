        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="menu-wrapper">
                    <div class="logo mr-5">
                        <a href="{{ route('admin.home') }}"><img src="{{ url('admin') }}/images/logo2.png"
                                alt="logo"></a>
                    ...
                    ?>
                    @if ($current_url == 'tour' || $current_url == 'trash' || $current_url == 'order' || $current_url == 'accountCustomer' || $current_url == 'accountAdmin' || $current_url == 'reviews')
                        @yield('search')
                    @else
                        <div class="dashboard-search-box">
                            <div class="contact-form-action">
                                ...
                                @else
                                    <form action="{{ $admin_url == 'adminstrator' ? '' : route($current_url . '.index') }}"
                                        method="GET">
                                        <div class="form-group mb-0">
                                            <input class="form-control" type="text" name="keyword"
                                                placeholder="Search" value="{{ $get_keyword }}">
                    ...
                    <div class="nav-btn ml-auto">
                        <div class="notification-wrap d-flex align-items-center">
                            ...
                            <div class="notification-item mr-2">
                                <div class="dropdown">
                                    <a href="#" class="dropdown-toggle drop-reveal-toggle-icon" id="messageDropdownMenu"
                                    ...
                                    <div class="dropdown-menu dropdown-reveal dropdown-menu-xl dropdown-menu-right">
                                        ...
                                        <div class="list-group drop-reveal-list">
                                            <a href="#" class="list-group-item list-group-item-action">
                                                <div class="msg-body d-flex align-items-center">
                                                    <div class="avatar flex-shrink-0 mr-3">
                                                        <img src="{{ url('admin') }}/images/team8.jpg" alt="">
                                                    </div>
                                                    <div class="msg-content w-100">
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action">
                                                <div class="msg-body d-flex align-items-center">
                                                    <div class="avatar flex-shrink-0 mr-3">
                                                        <img src="{{ url('admin') }}/images/team9.jpg" alt="">
                                                    </div>
                                                    <div class="msg-content w-100">
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action">
                                                <div class="msg-body d-flex align-items-center">
                                                    <div class="avatar flex-shrink-0 mr-3">
                                                        <img src="{{ url('admin') }}/images/team10.jpg" alt="">
                                                    </div>
                                                    <div class="msg-content w-100">
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action">
                                                <div class="msg-body d-flex align-items-center">
                                                    <div class="avatar flex-shrink-0 mr-3">
                                                        <img src="{{ url('admin') }}/images/team11.jpg" alt="">
                                                    </div>
                                                    <div class="msg-content w-100">
                                                        <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="dropdown">
                                    <a href="#" class="dropdown-toggle" id="userDropdownMenu" data-toggle="dropdown"
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm flex-shrink-0 mr-2"> @if (Auth::check())<img src="{{ url('admin') }}/images/{{ Auth::user()->avatar }}" alt="team-img">@else<img src="{{ url('admin') }}/images/noadmin.png" alt="team-img">@endif
                                            </div>
                                            <span class="font-size-14 font-weight-bold">
                                                @if (Auth::check()){{ Auth::user()->name }}@else ADMIN @endif</span>
                                        </div>
                                    </a>
                                    <div class="dropdown-menu dropdown-reveal dropdown-menu-md dropdown-menu-right">
                                        ...
                                        <div class="list-group drop-reveal-list user-drop-reveal-list">
                                            @if (Auth::check())
                                                <a href="{{ route('accountAdmin.show', Auth::user()->id) }}"
                                                    class="list-group-item list-group-item-action">
                                                @else <a href="#" class="list-group-item list-group-item-action">
                                            @endif

                                            <div class="msg-body">
                                                <div class="msg-content">
                                                    <h3 class="title"><i class="la la-user mr-2"></i> Edit
                                                        Profile</h3>
                                                </div>
                                            </div><!-- end msg-body -->
                                            </a>
                                            <a href="{{ route('order.index') }}"
                                                ...
                                                <div class="msg-body">
                                                    <div class="msg-content">
                                                        <h3 class="title"><i
                                                                class="la la-shopping-cart mr-2"></i>Orders</h3>
                                                    </div>
                                                </div><!-- end msg-body -->
                                            </a>
                                            <a href="#" class="list-group-item list-group-item-action">
