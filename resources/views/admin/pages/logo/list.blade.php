                    ...
                    <form method="GET">
                        ...
                        <div class="form-title-wrap">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h3 class="title">Logo Lists</h3>
                                    <p class="font-size-14">Showing {{ $logo->firstItem() }}
                                        {{ $logo->count() != 1 ? 'to' . ' ' . $logo->count() : '' }} of
                                        {{ $logo->total() }} results</p>
                                </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($logo as $value)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td><img src="{{ url('admin/images') }}/{{ $value->logo }}" alt=""
                                                    width="100px"></td>
