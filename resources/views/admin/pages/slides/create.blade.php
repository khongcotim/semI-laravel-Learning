                ...
                <div class="col-lg-12">
                    <div class="form-box">
                        <div class="form-title-wrap">
                            <h3 class="title"><i class="la la-gear mr-2 text-gray"></i>Add New Slide</h3>
                        </div><!-- form-title-wrap -->
                        <div class="form-content contact-form-action">
                            <div class="col-lg-12">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('position')}}" class="form-control" type="number" name="position" placeholder="Enter position here">
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <span class="la la-briefcase form-icon"></span>
                                        <input value="{{old('link')}}" class="form-control" type="text" name="link" placeholder="Enter links here">
                                    </div>
                                    @if ($errors->has('link'))
                            ...
                            <div class="col-lg-12">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <span class="la la-briefcase form-icon"></span>
                                        <input value="{{old('max')}}" class="form-control" type="number" name="max" placeholder="Choose value here">
                                    </div>
                                    @if ($errors->has('max'))
                    ...
                    <div class="submit-box">
                        <div class="btn-box pt-3">
                            <button type="submit" class="theme-btn">Add New Slide <i class="la la-arrow-right ml-1"></i></button>
                        </div>
                    </div><!-- end submit-box -->
                </div><!-- end col-lg-12 -->
            </div><!-- end row -->
