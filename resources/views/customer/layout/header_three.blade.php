        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="account" role="tabpanel" aria-labelledby="account-tab">
                <div class="user-action-wrap user-sidebar-panel">
                    <div class="notification-item">
                        <a href="{{route('my_profile',Auth::guard('customer')->user()->id)}}" class="dropdown-item">
                        ...
                        <div class="list-group drop-reveal-list user-drop-reveal-list">
                            ...
                            <a href="{{route('my-booking')}}" class="list-group-item list-group-item-action">
                                <div class="msg-body">
                                    <div class="msg-content">
                            ...
                            <a href="{{route('customer.logout',['page'=>'my_profile'])}}" class="list-group-item list-group-item-action">
                                <div class="msg-body">
                                    <div class="msg-content">
