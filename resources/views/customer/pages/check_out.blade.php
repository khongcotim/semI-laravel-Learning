...
================================= -->
@if ($checkout_banner!=null)
    <section class="breadcrumb-area bread-bg-10" style="background-image: url('{{url('admin/images')}}/{{$checkout_banner!=null}}')">
                    ...
                    <div class="col-lg-12">
                        <div class="breadcrumb-content text-center">
                            <div class="section-heading">
                                <h2 class="sec__title text-white">{{$checkout_banner->title}}</h2>
                            </div>
                                        ...
                                        <div class="input-box">
                                            <div class="form-group mb-0">
                                                <div class="custom-checkbox mb-0">
                                                    ...
                                                    <label for="receiveChb">I want to receive TLS's promotional offers in the future</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- end col-lg-12 -->
                            ...
                            <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="paypal-tab" data-toggle="tab" href="#paypal" role="tab" aria-controls="paypal" aria-selected="true">
                                        <i class="la la-check icon-element"></i>
                                        <img src="{{url('customers')}}/images/paypal.png" alt="">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="payoneer-tab" data-toggle="tab" href="#payoneer" role="tab" aria-controls="payoneer" aria-selected="true">
                                        <i class="la la-check icon-element"></i>
                                        <img src="{{url('customers')}}/images/payoneer.png" alt="">
                        ...
                        <div class="card-item shadow-none radius-none mb-0">
                            <div class="card-img pb-4">
                                <a href="room-details.html" class="d-block">
                                    <img src="{{url('customers')}}/images/img5.jpg" alt="room-img">
                                </a>
                            </div>
